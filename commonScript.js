  ...
  let navbarContent = `
       <div class="leftSection">
              <a class="flex items-center" href="../index.html">
                ...
                <span
                  class="ml-3 text-base lg:text-2xl uppercase font-semibold projectName tracking-widest ease-in-out duration-300 hover:text-indigo-600">Mukti</span>
              </a>
  ...
  let footerContent = `
    <!-- NewsLetter  -->
          ...
          <div class="mb-1 text-center lg:text-left w-1/2">
              ...
              <p style = "color:white">Get weekly updates regarding Mukti.</p>
            </div>
          ...
          <div class="mt-8 siteNav flex flex-col lg:flex-row ">
            ...
            <div class="flex flex-col lg:flex-row items-center text-center lg:text-left lg:w-1/2">
              ...
              <div class="py-3 font-medium text-white w-2/3 flex flex-col text-xs">
                <h1 class="text-3xl projectName">Mukti</h1>
                <span>
                ...
                <div class="social flex justify-center lg:justify-start items-center gap-x-4 mt-4">
                  <a href="https://github.com/Aditi323/Mukti">
          ...
          <div class="mt-8 copyRight flex items-center justify-center text-xs text-slate-300 flex-col">
            <p class='text-center' style = "color:white;" >Made by Aditi</p>
            <p class="text-slate-300 font-bold">
              &copy; <span id="copyright-year"></span> Mukti. All rights reserved.
            </p>
          </div>
  `
